...
## Core
Interw.ai: SaaS plateforme d'entretien vidéo IA pour recrutement. Primary #6366F1 (indigo), Inter font.
Lovable Cloud backend with RLS. Roles in separate user_roles table with has_role() SECURITY DEFINER.
Tables: organizations, profiles, user_roles, projects, questions, evaluation_criteria, sessions, session_messages, transcripts, reports.
