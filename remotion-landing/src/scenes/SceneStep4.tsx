        ...
        <BrowserChrome url="interw.ai/projects/new" width={780} height={620}>
          ...
          <div style={{ padding: "40px 36px" }}>
            ...
            >
              ...
              <button
                style={{
                  background: copyFlash > 0.5 ? "#16A34A" : `linear-gradient(135deg, ${ACCENT}, #3F3F46)`,
                  color: "#FFFFFF",
                  fontSize: 13,
                  fontWeight: 600,
                  padding: "8px 14px",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 24 }}>
            <div
              style={{
                ...
                height: 96,
                borderRadius: 48,
                background: `conic-gradient(${ACCENT} ${score * 3.6}deg, rgba(9,9,11,0.06) 0deg)`,
                display: "flex",
                alignItems: "center",
            ...
            <div>
              ...
              <div style={{ color: "#16A34A", fontSize: 18, fontWeight: 600, marginTop: 4 }}>👍 Recommandé</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[
              ...
              <div key={c.l}>
                ...
                <div style={{ height: 4, background: "rgba(9,9,11,0.06)", borderRadius: 2, overflow: "hidden" }}>
...
const Stat: React.FC<{ label: string; value: string; highlight?: boolean }> = ({ label, value, highlight }) => (
  <div style={{ flex: 1, background: "rgba(9,9,11,0.03)", border: `1px solid ${BORDER}`, borderRadius: 10, padding: "12px 14px" }}>
    <div style={{ color: FG_DIM, fontSize: 11, textTransform: "uppercase", letterSpacing: 1.2 }}>{label}</div>
    <div style={{ color: highlight ? "#16A34A" : FG, fontSize: 20, fontWeight: 600, marginTop: 2 }}>{value}</div>
  </div>
);
