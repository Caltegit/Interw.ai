            ...
            <div>
              ...
              <div
                style={{
                  ...
                  color: FG,
                  height: 26,
                  boxShadow: `0 0 0 4px rgba(9,9,11,0.12)`,
                }}
              >
                {typedText}
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
              ...
              >
                <div
                  style={{
                    ...
                    inset: -20,
                    borderRadius: 200,
                    background: `radial-gradient(circle, rgba(9,9,11,0.35), transparent 65%)`,
                    filter: "blur(20px)",
                  }}
                />
                <div
                  style={{
                    ...
                    border: `4px solid rgba(9,9,11,0.6)`,
                    display: "flex",
                    alignItems: "center",
              ...
              <div
                style={{
                  ...
                  border: `1px solid rgba(9,9,11,0.4)`,
                  borderRadius: 24,
                  padding: "8px 16px",
                  color: ACCENT,
                  fontSize: 14,
