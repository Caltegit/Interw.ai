REVOKE EXECUTE ON FUNCTION public.admin_list_impacted_candidates() FROM anon;
REVOKE EXECUTE ON FUNCTION public.admin_list_impacted_candidates() FROM PUBLIC;
