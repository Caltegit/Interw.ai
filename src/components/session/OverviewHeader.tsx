...
import { Clock, MessageSquare, Video, Target, HelpCircle, Calendar } from "lucide-react";
    ...
    <Card>
      <CardContent className="pt-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          ...
          {createdAt && (
            <div className="flex items-center gap-1 text-sm text-muted-foreground md:self-start">
