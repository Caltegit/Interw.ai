        ...
        <Card className="max-w-md w-full text-center overflow-hidden">
          ...
          <CardContent className="py-14 space-y-6">
            <div className="relative mx-auto flex h-20 w-20 items-center justify-center animate-scale-in">
              ...
              <div className="relative flex h-20 w-20 items-center justify-center rounded-full" style={{ backgroundColor: "rgba(34, 197, 94, 0.15)" }}>
            ...
            <div className="flex items-center justify-center gap-2 text-sm" style={{ color: "rgba(245, 240, 232, 0.4)" }}>
              <Sparkles className="h-4 w-4" />
              <span>Propulsé par Morning</span>
            </div>
          </CardContent>
        </Card>
      </div>
