...
import { ArrowLeft, Crown, ShieldCheck, User, Users, Briefcase, Pencil, Trash2, LogIn, Link2 } from "lucide-react";
                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      toast({ title: "Lien copié", description: "Valable 5 jours, utilisable une seule fois." });
                    } catch (e: any) {
